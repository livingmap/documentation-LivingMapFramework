...
If you have not already installed, Guzzle, head over to the 
page.
...
handlers-and-middleware page of the documentation.
...
``NO_PROXY``
    Defines URLs for which a proxy should not be used. See proxy-option for usage.
